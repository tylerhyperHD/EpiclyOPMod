...
import net.camtech.camutils.CUtils_NBTFactory.NbtCompound;
import net.camtech.camutils.CUtils_NBTFactory.NbtList;
import org.bukkit.inventory.ItemStack;

public class CUtils_Attribute
{
    ...
    public static final class Attribute
    {
        ...
        {
            data = CUtils_NBTFactory.createCompound();
    ...
    public CUtils_Attribute(ItemStack stack)
    {
        // Create a CraftItemStack (under the hood)
        this.stack = CUtils_NBTFactory.getCraftItemStack(stack);
    ...
    private void loadAttributes(boolean createIfMissing)
    {
        ...
        {
            NbtCompound nbt = CUtils_NBTFactory.fromItemTag(this.stack);
