...
public enum CUtils_Particle
{
    ...
    CUtils_Particle(String name, int id)
    {
        this.name = name;
        this.id = id;
    }
     ...
     */
    public static void sendToPlayer(CUtils_Particle effect, Player player, Location location, float offsetX, float offsetY,
     ...
     * @param count The count of effects
     */
    public static void sendToLocation(CUtils_Particle effect, Location location, float offsetX, float offsetY, float offsetZ, float speed, int count)
    {
        try
        {
            Object packet = createPacket(effect, location, offsetX, offsetY, offsetZ, speed, count);
    ...
    private static Object createPacket(CUtils_Particle effect, Location location, float offsetX, float offsetY,
    ...
    public static void sendToAll(CUtils_Particle effect, Location location, float offsetX, float offsetY, float offsetZ, float speed, int count)
    {
        for(Player player : Bukkit.getOnlinePlayers())
        {
            sendToPlayer(effect, player, location, offsetX, offsetY, offsetZ, speed, count);
        }
    }
