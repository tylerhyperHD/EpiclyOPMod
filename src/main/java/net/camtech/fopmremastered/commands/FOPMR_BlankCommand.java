...
public class FOPMR_BlankCommand extends FOPMR_Command {
	...
	public FOPMR_BlankCommand(String name, String usage, String description, List<String> aliases, Rank rank,
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		try {
			return (boolean) clazz
					.getMethod("onCommand", CommandSender.class, Command.class, String.class, String[].class)
					.invoke(object, sender, cmd, label, args);
