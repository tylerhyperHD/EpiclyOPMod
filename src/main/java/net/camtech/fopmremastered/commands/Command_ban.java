...
public class Command_ban extends FOPMR_Command {
	...
	public Command_ban() {
		super("ban", "/ban [player] <reason>", "Ban a player.", "You don't have permission to use this command.",
				Rank.ADMIN);
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (player == null) {
			Bukkit.broadcastMessage(
					ChatColor.RED + sender.getName() + " - Attempting ban of offline player: " + args[0]);
			...
			Bukkit.broadcastMessage(
					ChatColor.RED + sender.getName() + " - Attempting to ban player: " + player.getName());
