...
public class Command_setspawnworld {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		world.setSpawnLocation(player.getLocation().getBlockX(), player.getLocation().getBlockY(),
				player.getLocation().getBlockZ());
		sender.sendMessage(ChatColor.GREEN + "Successfully changed the spawn point of " + world.getName() + " to "
