...
public class Command_o {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		if (FOPMR_Rank.isSuper(sender)) {
			sender.sendMessage(
					ChatColor.RED + "If you are a super admin or higher rank, use '/cl 2' to toggle super admin chat.");
		} else if (FOPMR_Rank.isSenior(sender)) {
			sender.sendMessage(ChatColor.RED
					+ "If you are a senior admin or higher rank, use '/cl 3' to toggle senior admin chat.");
		}
		return true;
	}
}
