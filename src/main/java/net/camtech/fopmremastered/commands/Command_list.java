...
public class Command_list extends FOPMR_Command {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		sender.sendMessage(
				ChatColor.WHITE + "There are " + names.size() + "/" + Bukkit.getMaxPlayers() + " players online:\n");
		...
		if (joined.size() != names.size()) {
			sender.sendMessage(ChatColor.GREEN + "Showing all " + ChatColor.BLUE + joined.size() + ChatColor.GREEN
					+ " players that fit the category selected.");
		}
