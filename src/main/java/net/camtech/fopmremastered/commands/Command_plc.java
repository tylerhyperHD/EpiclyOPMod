...
public class Command_plc {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		sender.sendMessage(ChatColor.GREEN + "Action " + ChatColor.AQUA + args[0].toLowerCase() + ChatColor.GREEN
				+ " performed on " + ChatColor.AQUA + plugin.getName() + ChatColor.GREEN + " successfully.");
		return true;
	}
}
