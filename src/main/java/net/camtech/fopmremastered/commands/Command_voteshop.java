...
public class Command_voteshop {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		player.sendMessage(
				CUtils_Methods.colour("&-You have " + CUtils_Methods.randomChatColour() + FreedomOpModRemastered.configs
						.getAdmins().getConfig().getInt(player.getUniqueId().toString() + ".votes") + " &-votes."));
