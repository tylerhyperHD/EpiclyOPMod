...
public class FOPMR_ProtectedArea {
	...
	public FOPMR_ProtectedArea(String owner, String name, ArrayList<String> allowed, Rank rank, Location loc,
			int range) {
		this.owner = owner;
		this.name = name;
	...
	public boolean addPlayer(Player sender, Player player) {
		...
		player.sendMessage(ChatColor.GREEN + "You have been added to the protected area " + this.name + " by "
				+ sender.getName() + ".");
		return true;
	}
